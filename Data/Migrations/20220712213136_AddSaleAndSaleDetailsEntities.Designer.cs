...
namespace TSShopping.Data.Migrations
{
    ...
    [Migration("20220712213136_AddSaleAndSaleDetailsEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TSShopping.Data.Entities.Sale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TSShopping.Data.Entities.SaleDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TSShopping.Data.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TSShopping.Data.Entities.SaleDetail", b =>
                {
                    ...
                    b.HasOne("TSShopping.Data.Entities.Sale", "Sale")
                        .WithMany("SaleDetails")
            ...
            modelBuilder.Entity("TSShopping.Data.Entities.User", b =>
                {
                    b.HasOne("TSShopping.Data.Entities.City", "City")
                        .WithMany("Users")
